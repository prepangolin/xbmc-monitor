...
namespace XBMCLogging
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //Checking if the path property is set for the first time the program is run
            if (path.Equals(""))
                setPath(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\XBMC\\xbmc.log");
            else
        ...
        {
            //Initializing the ConetxMenuStrip
        ...
        private void clearButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DialogResult dr = MessageBox.Show("This will clear the log Window.\nDo you want to clear the contents of the file as-well ?", "Clear !", MessageBoxButtons.YesNoCancel);
        ...
        private void locationTextBox_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Could not read file from disk !", "Error !", MessageBoxButtons.OK);
                }
            }
        }
